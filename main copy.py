...
df_selection = dashboard_df.query(
    """
    LEVEL01 == @level1 & LEVEL02 == @level2 & LEVEL03 == @level3 & Material_Type == @material_type & Lag ==@lag & Sales_org == @sales_org & Item == @item & Division ==@division & Cust_Facing_Loc ==@cust_facing_loc
    """
    )
